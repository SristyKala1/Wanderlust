...
ALTER TABLE BOOKING ADD CONSTRAINT WL_BOOOKING_USER_FK FOREIGN KEY ( USER_ID ) REFERENCES USERS ( USER_ID );
ALTER TABLE BOOKING ADD CONSTRAINT WL_BOOOKING_DESTINATION_FK FOREIGN KEY ( DESTINATION_ID ) REFERENCES DESTINATION ( DESTINATION_ID );
...
INSERT INTO DESTINATION VALUES ('D1001','Europe','A Week in Greece: Athens, Mykonos & Santorini','/assets/geece.jpg',7,500.0,2499.0,0.0,30,4,1,'DL101');
INSERT INTO DESTINATION VALUES ('D1002','Europe','Romantic Europe: Paris, Venice & Vienna','/assets/romantic.jpg',10,500.0,2729.0,0.0,30,0.0,0.00,'DL102');
INSERT INTO DESTINATION VALUES ('D1003','Europe','Jewels of Alpine Europe','/assets/europe.jpg',11,500.0,2799.0,0.0,30,5,1,'DL103');
INSERT INTO DESTINATION VALUES ('D1004','Europe','Highlights of Eastern Europe','/assets/easteurope.jpg',13,500.0,2699.0,0.0,30,3,1,'DL104');
INSERT INTO DESTINATION VALUES ('D1005','Europe','London, Paris & Rome','/assets/rome.jpg',13,500.0,2699.0,0.0,30,0.0,0.0,'DL105');
INSERT INTO DESTINATION VALUES ('D1006','Australia','Grand Tour of Australia','/assets/aus1.jpg',14,500.0,4549.0,0.0,30,0.0,0.0,'DL106');
INSERT INTO DESTINATION VALUES ('D1007','Australia','Australia & New Zealand','/assets/aus2.jpg',22,500.0,6399.0,0.0,30,0.0,0.0,'DL107');
INSERT INTO DESTINATION VALUES ('D1008','Asia','China: Beijing, the Yangtze & Shanghai','/assets/china.jpg',13,500.0,2399.0,0.0,30,0.0,0.0,'DL108');
INSERT INTO DESTINATION VALUES ('D1009','South America','Food & Wine: Uruguay, Argentina & Chile','/assets/wine.jpg',8,500.0,3549.0,0.0,30,0.0,0.0,'DL109');
INSERT INTO DESTINATION VALUES ('D1010','Asia','Singapore & Malaysia: A Journey through Southeast Asia','/assets/singapore.jpg',9,500.0,2649.0,0.0,30,0.0,0.0,'DL110');
INSERT INTO DESTINATION VALUES ('D1011','Asia','Highlights of Japan: Tokyo to Kyoto','/assets/tokyo.jpg',8,500.0,3349.0,0.0,30,0.0,0.0,'DL111');
INSERT INTO DESTINATION VALUES ('D1012','Asia','Thailand : The Golden Kingdom','/assets/Thailand.jpg',11,400.0,2249.0,5.0,15,0.0,0.0,'DL112');
INSERT INTO DESTINATION VALUES ('D1013','Europe','Budapest, Vienna & Prague','/assets/prague.jpg',9,400.0,2049.0,5.0,15,0.0,0.0,'DL113');
INSERT INTO DESTINATION VALUES ('D1014','Australia','Australia & New Zealand','/assets/aus3.jpg',19,400.0,6399.0,5.0,15,0.0,0.0,'DL114');
-- INSERT CODE TO USERS TABLE
...
INSERT INTO BOOKING VALUES (1006,sysdate()- interval 3 day,sysdate()+ interval 8  day,5,13495.0,current_time(),'D1005',101);


INSERT INTO REVIEW VALUES(10001,'Very Good',4,sysdate(),'',1001);
INSERT INTO REVIEW VALUES(10002,'Trip was excellent',5,sysdate(),'',1003);
INSERT INTO REVIEW VALUES(10003,'Service was not good as expected',3,sysdate(),'',1004);
