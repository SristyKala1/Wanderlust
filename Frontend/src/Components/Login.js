    ...
    return (
      <div className="terms-bg">
        <div className="row my-0">
          ...
          <h5>Welcome to WanderLust</h5>
          </div>
          <div className="card-body  px-5">
            <form className="form form-horizontal">
            
              <div className="form-group my-0 ">
              <label htmlFor="contactNumber" className='text-muted float-left'>
                      Contact Number
                    </label>
              ...
              <br />
              <div className="form-group my-0">
              <label htmlFor="password" className="text-muted float-left">
                      Password
                    </label>
                <span className="p-float-label">
                  <InputText
              ...
              <div className="form-group mt-3">
                <div className="row">
                  ...
                  <div className="col">
                    <button
                      type="submit"
                      className="col btn btn-danger form-control"
                    >
                      Back
                    </button>
                  </div>
                ...
                <div>
                <span><p className="text-dark text-info mt-3">Don't have an account?</p></span>
                </div>
                <button
                  type="submit"
                  className="col btn btn-primary form-control my-0"
